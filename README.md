...
핵심 기능인 `#travel-indoor`는 제공받은 역사 내 AI 안내 스크린샷 3장을 중심으로 층별 동선·단계별 이동·추천 승차 위치를 소개합니다. 데스크톱에서는 세 화면을 나란히, 모바일에서는 좌우 스크롤로 크게 보여줍니다. 이미지를 누르면 원본이 새 탭에서 열립니다. 제공 화면과 현재 UI의 차이는 섹션 하단에 표기합니다.
